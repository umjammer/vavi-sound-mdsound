...
public class ym2151_x68sound extends Instrument
    {
        private final int DefaultYM2151ClockValue = 4000000;//X68000 clock 

        @Override public String getName()  { return "YM2151x68sound"; } 
        @Override public String getShortName() {   return "OPMx"; } 
        ...
        public sound_iocs[] sound_Iocs = new sound_iocs[] { null, null };

        private short[][] buf = new short[][] { new short[2], new short[2] };
