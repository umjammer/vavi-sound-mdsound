...
public class ym3438_const
    {
        ...
        // note table
        public static final int[] fn_note = new int[] { 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 3, 3, 3, 3, 3, 3 };

        // Env Gen
        public static final int[][] eg_stephi = new int[][]{
            new int[]{ 0, 0, 0, 0 },
            new int[]{ 1, 0, 0, 0 },
            new int[]{ 1, 0, 1, 0 },
            new int[]{ 1, 1, 1, 0 }
        };
        public static final byte[] eg_am_shift = { 7, 3, 1, 0 };

        // Phase Gen
        public static final int[] pg_detune = new int[] { 16, 17, 19, 20, 22, 24, 27, 29 };


        public static final int[][] pg_lfo_sh1 = new int[][]{
        ...
        public static final int[][] pg_lfo_sh2 = new int[][]{
            new int[]{ 7, 7, 7, 7, 7, 7, 7, 7 },
        ...
        //Address Decod
        public static final int[] op_offset = new int[] {
            0x000, /* Ch1 OP1/OP2 */
            0x001, /* Ch2 OP1/OP2 */
            0x002, /* Ch3 OP1/OP2 */
            0x100, /* Ch4 OP1/OP2 */
        ...
        public static final int[] ch_offset = new int[]
        {
            0x000, /* Ch1 */
            0x001, /* Ch2 */
            0x002, /* Ch3 */
        ...
        public static final int[] lfo_cycles = { 108, 77, 71, 67, 62, 44, 8, 5 };

        public static final int[][][] fm_algorithm = new int[][][] {
                new int[][]{
        ...
        {
            discrete, /* Discrete YM3438 (Teradrive)          (with ladderEffect)                                  */
            asic,     /* ASIC YM3438 (MD1 VA7, MD2, MD3, etc) (pure Sound)                                         */
            ym2612,   /* YM2612 (MD1, MD2 VA2)                (with ladderEffect + Amplify signal + lowpassfilter) */
            ym2612_u, /* YM2612 without lowpass filter 		  (with ladderEffect + Amplify signal)                 */
            asic_lp   /* ASIC with lowpass filter             (with lowpassfilter)                                 */
        };
