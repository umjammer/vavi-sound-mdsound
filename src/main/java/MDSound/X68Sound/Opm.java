...
public class Opm
    {
        ...
        private final static int CMNDBUFSIZE = 65535;

        //#define	RES	(20)
        //#define	NDATA	(44100/5)
        private final static int PCMBUFSIZE = 65536;
        //#define	DELAY	(1000/5)
...
// #endif
        ...
        //public void pcmset62(int ndata)
        {
            ...
            for (i = 0; i < ndata / 2; ++i)
            {
                ...
                global.OpmFir(OpmLPFpBuf[OpmLPFpPtr], InpOpmBuf0, (int)InpOpm_idx, InpOpmBuf1, (int)InpOpm_idx, OutOpm);
...
// #endif
        ...
        private int WaveAndTimerStart()
        {
            ...
            global.Betw_Samples_Faster = (int)Math.ceil((double)(global.WaveOutSamp) * _betw / 1000.0 + _rev);
            ...
            PcmBufSize = (int)(global.Blk_Samples * global.N_waveblk);
            global.nSamples = (int)(global.Betw_Samples_Faster);
            ...
            PcmBufPtr = (int)(global.Blk_Samples + global.Late_Samples + global.Betw_Samples_Faster);
...
// #endif
        ...
        public int Pcm8_Out(int ch, byte[] adrsBuf,int adrsPtr, int mode, int len)
        {
            return pcm8[ch & (global.PCM8_NCH - 1)].Out(adrsBuf, adrsPtr, mode, len);
        }

        public int Pcm8_Aot(int ch, byte[] tblBuf,int tblPtr, int mode, int cnt)
        {
