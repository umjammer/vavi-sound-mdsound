package MDSound.X68Sound;
    public class lfo
    {
        ...
        private final int SIZELFOTBL = 512;             // 2^9
        private final int SIZELFOTBL_BITS = 9;
        private final int LFOPRECISION = 4096;	// 2^12
        ...
        private int[] PMSMUL = new int[] { 0, 1, 2, 4, 8, 16, 32, 32 };
        private int[] PMSSHL = new int[] { 0, 0, 0, 0, 0, 0, 1, 2 };
