package MDSound;
    ...
    public class qsound extends Instrument
    {
        ...
        *********************************************************/
        ...
        private final int QSOUND_CLOCK = 4000000;   /* default 4MHz clock */
        ...
        */
        ...
        private final int QSOUND_CLOCKDIV = 166;       /* Clock divider */
        private final int QSOUND_CHANNELS = 16;
