...
package MDSound;
    ...
    {
        private final int PWM_BUF_SIZE = 4;
        ...
        private final int CHILLY_WILLY_SCALE = 1;
        ...
        private byte[] PWM_FULL_TAB = new byte[]
        {
        ...
        {
            public int[] PWM_FIFO_R = new int[8];
            public int[] PWM_FIFO_L = new int[8];
            public int PWM_RP_R;
            public int PWM_WP_R;
            public int PWM_RP_L;
            public int PWM_WP_L;
            public int PWM_Cycles = 0;
            public int PWM_Cycle;
            public int PWM_Cycle_Cnt;
            public int PWM_Int;
            public int PWM_Int_Cnt;
            public int PWM_Mode;
            //unsigned int PWM_Enable;
            public int PWM_Out_R;
            public int PWM_Out_L;

            public int PWM_Cycle_Tmp;
            public int PWM_Cycles_Tmp = 0;
            public int PWM_Int_Tmp;
            public int PWM_FIFO_L_Tmp;
            public int PWM_FIFO_R_Tmp;
        ...
        //#if CHILLY_WILLY_SCALE
        // TODO: Fix Chilly Willy's new scaling algorithm.
        private final int PWM_Loudness = 0;
        //#endif
        ...
        private pwm_chip[] PWM_Chip = new pwm_chip[] { new pwm_chip(), new pwm_chip() };
        ...
        private void PWM_Set_Cycle(pwm_chip chip, int cycle)
        {
            cycle--;
        ...
        private void PWM_Set_Int(pwm_chip chip, int int_time)
        {
            int_time &= 0x0F;
            if (int_time != 0)
        ...
        private int PWM_Update_Scale(pwm_chip chip, int PWM_In)
        {
            ...
            //#else
            //    final int PWM_adjust = ((chip.PWM_Cycle >> 1) + 1);
        ...
        @Override public String getName() { return "PWM"; } 
        @Override public String getShortName() { return "PWM"; } 
        ...
        private void pwm_chn_w(byte ChipID, byte Channel, int data)
        {
            pwm_chip chip = PWM_Chip[ChipID];
        ...
        {
            pwm_chn_w(ChipID, (byte)adr, (int)data);
            return 0;
        }
    }
