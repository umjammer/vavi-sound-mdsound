...
import java.util.function.BiConsumer;
    ...
    public class ym_deltat
    {
        ...
        public final static int YM_DELTAT_EMULATION_MODE_NORMAL = 0;
        public final static int YM_DELTAT_EMULATION_MODE_YM2610 = 1;


        public interface dlgSTATUS_CHANGE_HANDLER extends BiConsumer<fm.FM_base, Byte>{}
        ...
        //(int)8 YM_DELTAT_ADPCM_Read(YM_DELTAT* DELTAT);
...
// #endif
                    ...
                    if ((DELTAT.control2 & 3) != (v & 3))
                    {
                        ...
                        if (DELTAT.DRAMportshift != dram_rightshift[v & 3])
                        {
                            ...
                            */
                            ...
                            /* refresh addresses */
                            DELTAT.start = (int)((DELTAT.reg[DELTAT.regPtr+0x3] * 0x0100 | DELTAT.reg[DELTAT.regPtr + 0x2]) << (DELTAT.portshift - DELTAT.DRAMportshift));
                            DELTAT.end = (int)((DELTAT.reg[DELTAT.regPtr + 0x5] * 0x0100 | DELTAT.reg[DELTAT.regPtr + 0x4]) << (DELTAT.portshift - DELTAT.DRAMportshift));
                            DELTAT.end += (int)((1 << (DELTAT.portshift - DELTAT.DRAMportshift)) - 1);
                            DELTAT.limit = (int)((DELTAT.reg[DELTAT.regPtr + 0xd] * 0x0100 | DELTAT.reg[DELTAT.regPtr + 0xc]) << (DELTAT.portshift - DELTAT.DRAMportshift));
                        }
                    }
                ...
                case 0x0a:  /* DELTA-N H */
                    DELTAT.delta = (int)(DELTAT.reg[DELTAT.regPtr + 0xa] * 0x0100 | DELTAT.reg[DELTAT.regPtr + 0x9]);
        ...
        private void logerror(String msg, Object... param)
        {
        ...
        private void YM_DELTAT_Limit(int val, int max, int min)
        {
            if (val > max) val = max;
