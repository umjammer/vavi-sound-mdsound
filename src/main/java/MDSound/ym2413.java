...
public class ym2413 extends Instrument
    {
        //# ifndef _EMU2413_H_
        //#define _EMU2413_H_
        ...
        **************************************************************************************/
        ...
        private final int OPLL_TONE_NUM = 1;
...
0x25,0x11,0x00,0x00,(byte)0xf8,(byte)0xfa,(byte)0xf8,0x55,
        ...
        private final int PG_WIDTH = (1 << 9);// PG_BITS);
        ...
        private final int DB_MUTE = (1 << 8);// DB_BITS);
        ...
        private final int PM_PG_WIDTH = (1 << 8);// PM_PG_BITS);
        private int PM_DP_BITS = 16;
        private int PM_DP_WIDTH = (1 << 16);//PM_DP_BITS);
        private int AM_PG_BITS = 8;
        private final int AM_PG_WIDTH = (1 << 8);//AM_PG_BITS);
        ...
        private int RATE_ADJUST(int x) { return (rate == 49716 ? (int)x : (int)((double)(x) * clk / 72 / rate + 0.5)); }        /* added 0.5 to round the value*/
    ...
    S2E (24.0), S2E (27.0), S2E (30.0), S2E (33.0), S2E (36.0), S2E (39.0), S2E (42.0), S2E (48.0)
        ...
        *****************************************************/
        ...
        private final int DefaultYM2413ClockValue = 3579545;

        @Override public int Start(byte ChipID, int SamplingRate)
        {
        ...
        @Override public String getName() { return "YM2413"; }
        @Override public String getShortName()  { return "OPLL"; }
