...
public class op
    {
        ...
        public final int KEYON = -1;
        public final int ATACK = 0;
        public final int DECAY = 1;
        public final int SUSTAIN = 2;
        public final int SUSTAIN_MAX = 3;
        public final int RELEASE = 4;
        public final int RELEASE_MAX = 5;

        public final int CULC_DELTA_T = (0x7FFFFFFF);
        public final int CULC_ALPHA = (0x7FFFFFFF);

        public static int IS_ZERO_CLOSS(int a, int b) { return ((a < 0 && b >= 0) || (a > 0 && b <= 0)) ? 1 : 0; }

        public int[] NEXTSTAT = new int[] {
            DECAY, SUSTAIN, SUSTAIN_MAX, SUSTAIN_MAX, RELEASE_MAX, RELEASE_MAX,
        };
        public int[] MAXSTAT = new int[] {
