...
public class Gb extends Instrument.BaseInstrument {
    ...
    public static class GbSound {
        ...
        public static class Sound {
            ...
            public void sweep(byte data, byte oldData) {
            ...
            public void initializeHiFrequency(byte data, int cycles) {
            ...
            public void initializeHiFrequency2(byte data, int cycles) {
                this.registers[4] = data;
            ...
            public void initializeHiFrequency3(byte data, int cycles, byte mode) {
                this.registers[4] = data;
            ...
            public void corruptWaveRam(byte mode) {
                if (mode != MODE_DMG)
                    return;
            ...
            public void initializeHiFrequency4(byte data, int cycles) {
                this.registers[4] = data;
            ...
            public void envelope(byte data) {
