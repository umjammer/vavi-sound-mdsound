    ...
    */
    public static class HuC6280State {
        ...
        public class Psg {
            ...
            public boolean mute; // Kitao追加。v1.29
            public int ddaFadeOutL; // Kitao追加
            public int ddaFadeOutR; // Kitao追加
            ...
            public void porcessWave(byte data) {
                data &= 0x1F;
             ...
             * @param r OUT
             */
            public void mix(int c, int[] l, int[] r) {
        ...
        public boolean waveCrash;
        // はにいいんざすかいパッチ用。v2.60
        public boolean honeyInTheSky;
    ...
    private HuC6280State[] chips = new HuC6280State[2];
    ...
    public int start(byte chipId, int samplingRate, int clockValue, Object... option) {
        chips[chipId] = new HuC6280State(clockValue, samplingRate);
