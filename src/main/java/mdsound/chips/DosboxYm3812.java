...
public class DosboxYm3812 {
    ...
    private static class Opl {
        ...
        private Opl.OpFuncs[] opFuncs = new Opl.OpFuncs[] {
                ...
                Opl.Op::decay,
                Opl.Op::release,
                Opl.Op::sustain, // sustain phase (keeping level)
                Opl.Op::release, // sustain_nokeep phase (release-style)
                Opl.Op::off
        };
...
//                        clipit16(outBufL[i],sndPtr++);
    ...
    public void updateStream(int[][] outputs, int samples) {
        switch (EMU_CORE) {
        case EC_MAME:
            break;
        case EC_DBOPL:
