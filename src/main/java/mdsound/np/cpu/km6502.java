...
//        public delegate void dlgWriterHandler(km6502 user, int adr, int value);
    ...
    private static final int IRQ_INIT = K6502_IRQ.K6502_INIT.ordinal();

    private static final int IRQ_RESET = K6502_IRQ.K6502_RESET.ordinal();

    private static final int IRQ_NMI = K6502_IRQ.K6502_NMI.ordinal();

    private static final int IRQ_BRK = K6502_IRQ.K6502_BRK.ordinal();

    private static final int IRQ_INT = K6502_IRQ.K6502_INT.ordinal();
