...
public class K005289 extends Instrument.BaseInstrument {
    ...
    static class K005289State {
         ...
         */
        private void update(int[][] inputs, int[][] outputs, int samples) {
        ...
        private void writeControlA(byte data) {
            volume[0] = (byte) (data & 0xf);
            waveForm[0] = data & 0xe0;
        }

        private void writeControlB(byte data) {
            volume[1] = (byte) (data & 0xf);
            waveForm[1] = (data & 0xe0) + 0x100;
        }

        private void writeLd1(int offset, byte data) {
            freqLatch[0] = 0xfff - offset;
        }

        private void writeLd2(int offset, byte data) {
            freqLatch[1] = 0xfff - offset;
        }

        private void writeTg1(byte data) {
            frequency[0] = freqLatch[0];
        }

        private void writeTg2(byte data) {
